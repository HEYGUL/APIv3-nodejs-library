...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.GetTransacEmailsList();
  });
  ...
  describe('GetTransacEmailsList', function() {
    it('should create an instance of GetTransacEmailsList', function() {
      ...
      //var instance = new SendinBlueApi.GetTransacEmailsList();
      //expect(instance).to.be.a(SendinBlueApi.GetTransacEmailsList);
    });
