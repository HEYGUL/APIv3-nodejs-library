...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendinBlueApi.GetTransacEmailsListTransactionalEmails();
  });
  ...
  describe('GetTransacEmailsListTransactionalEmails', function() {
    it('should create an instance of GetTransacEmailsListTransactionalEmails', function() {
      ...
      //var instance = new SendinBlueApi.GetTransacEmailsListTransactionalEmails();
      //expect(instance).to.be.a(SendinBlueApi.GetTransacEmailsListTransactionalEmails);
    });
